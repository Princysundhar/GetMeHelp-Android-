...
public class credit_point_payment extends AppCompatActivity {
    EditText e1,e2,e3;
    TextView e4;
    Button b1;
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (account_no.equalsIgnoreCase("")) {
                    e2.setError("Enter your account no");
                    flag++;
                }
//                if (!ifsc_code.matches(ifsc_pattern)) {
                if (ifsc_code.equalsIgnoreCase("")) {
                    e3.setError("Enter your ifsc code");
                    flag++;
                }
                            if (flag == 0) {
                            ...
                            sh.getString("ip", "");
                            url = sh.getString("url", "") + "android_credit_point_payment";
                                        ...
                                        public void onResponse(String response) {
                                            ...
                                            try {
                                                ...
                                                if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                                    Toast.makeText(credit_point_payment.this, "payment using credit point", Toast.LENGTH_SHORT).show();
                                                    Intent i = new Intent(getApplicationContext(), view_request.class);
                                                    startActivity(i);
                                                } else if (jsonObj.getString("status").equalsIgnoreCase("no")) {
                                                    Toast.makeText(credit_point_payment.this, "wrong bank details", Toast.LENGTH_SHORT).show();
