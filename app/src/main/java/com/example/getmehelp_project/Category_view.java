...
SharedPreferences sh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sh.getString("ip","");
        url = sh.getString("url","")+"android_view_category";
...
//                                    pdate[i] = u.getString("date");
                                ...
                                li.setAdapter(new Category_view_custom(getApplicationContext(), cid, category));//custom_view_service.xml and li is the listview object
