...
String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sh.getString("ip","");
        url = sh.getString("url","")+"android_view_service";
...
//                        Toast.makeText(getApplicationContext(), response, Toast.LENGTH_LONG).show();
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                li.setAdapter(new custom_view_service(getApplicationContext(), sid, service,amount));//custom_view_service.xml and li is the listview object
